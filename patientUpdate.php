            ...
            <div class="main">
                ...
                <form method= "POST" action="patientUpdate.php">
                    ...
                    <p> <font size="2" color=black> Date: <input type="date" name="date"> &nbsp;&nbsp; 
                        <font size="2" color=black> Start time: <input type="time" name="starttime"> &nbsp;&nbsp; 
                        <font size="2" color=black> End time: <input type="time" name="endtime"> &nbsp;&nbsp; </p>
                ...
                <?php
                    echo "//TODO: call proper fn and output whether the post was successful..</br>";
                ?>
